<%-- 
    Document   : main
    Created on : Nov 27, 2017, 5:00:54 PM
    Author     : Alyssa
--%>
            ...
            <table>
                ...
                <c:forEach var="d" items="${sales}">
                    <tr>
                        ...
                        <td class="viewButton">
                            <s:form action="ViewItem" method="post">
                                <input type="hidden" name="itemID" value="${d.ID}" />
                                <s:submit theme="simple" value="View Item" />
                            </s:form>
                        </td>
                    </tr>
                </c:forEach>
