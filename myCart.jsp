<%-- 
    Document   : myCart
    Created on : Nov 29, 2017, 5:11:45 PM
    Author     : Alyssa
--%>
...
<html>
    ...
    <body>
        ...
        <main>
            <h1>${account.firstName}'s Cart</h1>
            <table>
                <tr>
                    <th>Picture</th>
                    <th>Name</th>
                ...
                <c:forEach var="d" items="${account.purchases}">
                    <tr>
                        ...
                        <td class="viewButton">
                            <s:form action="RemoveFromCart" method="post">
                                <input type="hidden" name="itemID" value="${d.ID}" />
                                <s:submit theme="simple" value="Remove" />
                            </s:form>
                        </td>
                    </tr>
                </c:forEach>
                <s:form action="Checkout" method="post">
                    <s:submit theme="simple" cssClass="checkoutButton" value="Checkout" />
                </s:form>
            </table>
        </main>
    </body>
